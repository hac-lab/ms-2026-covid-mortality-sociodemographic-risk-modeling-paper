...
colnames(D) <- c("Out of Bag R2", "Global Fitted-Prediction R2")
D <- kbl(D, booktabs = T, linesep = "") %>% kable_styling(latex_options = "HOLD_position")


```

## Table T13: GWRF Alpha Wave OOB vs. Global Fitted-Prediction R2
...
## Table T14: GWRF Delta Wave: OOB vs Global Fitted-Prediction R2
...
## Table T15: GWRF Omicron Wave: OOB vs Global Fitted-Prediction R2
